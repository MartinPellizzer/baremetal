...
void MimManage_Handler(void)		__attribute__((weak, alias("Default_Handler")));
...
void TIM1_BRK_TIM0_Handler(void)	__attribute__((weak, alias("Default_Handler")));
...
void DMA2_Steam0_Handler(void)		__attribute__((weak, alias("Default_Handler")));
void DMA2_Steam1_Handler(void)		__attribute__((weak, alias("Default_Handler")));
void DMA2_Steam2_Handler(void)		__attribute__((weak, alias("Default_Handler")));
void DMA2_Steam3_Handler(void)		__attribute__((weak, alias("Default_Handler")));
void DMA2_Steam4_Handler(void)		__attribute__((weak, alias("Default_Handler")));
...
void OTG_HD_EP1_OUT_Handler(void)	__attribute__((weak, alias("Default_Handler")));
void OTG_HD_EP1_IN_Handler(void)	__attribute__((weak, alias("Default_Handler")));
...
uint32_t vectors[] __attribute__((section(".isr_vector"))) = 
{
	...
	(uint32_t)TIM1_BRK_TIM0_Handler,
	...
	(uint32_t)DMA2_Steam0_Handler,
	(uint32_t)DMA2_Steam1_Handler,
	(uint32_t)DMA2_Steam2_Handler,
	(uint32_t)DMA2_Steam3_Handler,
	(uint32_t)DMA2_Steam4_Handler,
	0,
	0,
	...
	(uint32_t)OTG_HD_EP1_OUT_Handler,
	(uint32_t)OTG_HD_EP1_IN_Handler,
